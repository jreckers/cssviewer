...
var CSSViewer_pMisc = new Array("overflow", "cursor", "visibility");
...
var CSSViewer_listTagNames = new Array("UL", "LI", "DD", "DT", "OL");
...
function UpdatefontText(element) {
        ...
        SetCSSPropertyIf(
                element,
                "font-weight",
                GetCSSProperty(element, "font-weight") != "400"
        );
        SetCSSPropertyIf(
                element,
                "font-variant",
                GetCSSProperty(element, "font-variant") != "normal"
        );
        SetCSSPropertyIf(
                element,
                "font-style",
                GetCSSProperty(element, "font-style") != "normal"
        );
        ...
        SetCSSPropertyIf(
                element,
                "letter-spacing",
                GetCSSProperty(element, "letter-spacing") != "normal"
        );
        SetCSSPropertyIf(
                element,
                "line-height",
                GetCSSProperty(element, "line-height") != "normal"
        );
        SetCSSPropertyIf(
                element,
                "text-decoration",
                GetCSSProperty(element, "text-decoration") != "none"
        );
        SetCSSPropertyIf(
                element,
                "text-align",
                GetCSSProperty(element, "text-align") != "start"
        );
        SetCSSPropertyIf(
                element,
                "text-indent",
                GetCSSProperty(element, "text-indent") != "0px"
        );
        SetCSSPropertyIf(
                element,
                "text-transform",
                GetCSSProperty(element, "text-transform") != "none"
        );
        SetCSSPropertyIf(
                element,
                "vertical-align",
                GetCSSProperty(element, "vertical-align") != "baseline"
        );
        SetCSSPropertyIf(
                element,
                "white-space",
                GetCSSProperty(element, "white-space") != "normal"
        );
        SetCSSPropertyIf(
                element,
                "word-spacing",
                GetCSSProperty(element, "word-spacing") != "normal"
        );
}
...
function UpdateColorBg(element) {
        ...
        SetCSSPropertyIf(
                element,
                "background-attachment",
                GetCSSProperty(element, "background-attachment") != "scroll"
        );
        SetCSSPropertyValueIf(
                element,
                "background-image",
                GetFileName(GetCSSProperty(element, "background-image")),
                GetCSSProperty(element, "background-image") != "none"
        );
        SetCSSPropertyIf(
                element,
                "background-position",
        ...
        SetCSSPropertyIf(
                element,
                "background-repeat",
                GetCSSProperty(element, "background-repeat") != "repeat"
        );
}
...
function UpdateBox(element) {
        ...
        var marginBottom = RemoveExtraFloat(
                GetCSSProperty(element, "margin-bottom")
        );
        var marginRight = RemoveExtraFloat(
                GetCSSProperty(element, "margin-right")
        );
        var marginLeft = RemoveExtraFloat(
        ...
        // padding
        var paddingTop = RemoveExtraFloat(
                GetCSSProperty(element, "padding-top")
        );
        var paddingBottom = RemoveExtraFloat(
                GetCSSProperty(element, "padding-bottom")
        );
        var paddingRight = RemoveExtraFloat(
                GetCSSProperty(element, "padding-right")
        );
        var paddingLeft = RemoveExtraFloat(
...
function UpdatePositioning(element) {
        SetCSSPropertyIf(
                element,
                "position",
                GetCSSProperty(element, "position") != "static"
        );
        SetCSSPropertyIf(
                element,
                "top",
                GetCSSProperty(element, "top") != "auto"
        );
        SetCSSPropertyIf(
                element,
                "bottom",
                GetCSSProperty(element, "bottom") != "auto"
        );
        SetCSSPropertyIf(
                element,
                "right",
                GetCSSProperty(element, "right") != "auto"
        );
        SetCSSPropertyIf(
                element,
                "left",
                GetCSSProperty(element, "left") != "auto"
        );
        SetCSSPropertyIf(
                element,
                "float",
                GetCSSProperty(element, "float") != "none"
        );
        ...
        SetCSSPropertyIf(
                element,
                "clear",
                GetCSSProperty(element, "clear") != "none"
        );
        SetCSSPropertyIf(
                element,
                "z-index",
                GetCSSProperty(element, "z-index") != "auto"
        );
}
...
function UpdateTable(element, tagName) {
        if (IsInArray(CSSViewer_tableTagNames, tagName)) {
                ...
                nbProperties += SetCSSPropertyIf(
                        element,
                        "border-collapse",
                        GetCSSProperty(element, "border-collapse") != "separate"
                );
                nbProperties += SetCSSPropertyIf(
                        element,
                        "border-spacing",
                        GetCSSProperty(element, "border-spacing") != "0px 0px"
                );
                nbProperties += SetCSSPropertyIf(
                        element,
                        "caption-side",
                        GetCSSProperty(element, "caption-side") != "top"
                );
                nbProperties += SetCSSPropertyIf(
                        element,
                        "empty-cells",
                        GetCSSProperty(element, "empty-cells") != "show"
                );
                nbProperties += SetCSSPropertyIf(
                        element,
                        "table-layout",
                        GetCSSProperty(element, "table-layout") != "auto"
                );
...
function UpdateList(element, tagName) {
        if (IsInArray(CSSViewer_listTagNames, tagName)) {
                ...
                var listStyleImage = GetCSSProperty(
                        element,
                        "list-style-image"
                );
...
function UpdateMisc(element) {
        ...
        nbProperties += SetCSSPropertyIf(
                element,
                "overflow",
                GetCSSProperty(element, "overflow") != "visible"
        );
        nbProperties += SetCSSPropertyIf(
                element,
                "cursor",
                GetCSSProperty(element, "cursor") != "auto"
        );
        nbProperties += SetCSSPropertyIf(
                element,
                "visibility",
                GetCSSProperty(element, "visibility") != "visible"
        );
...
function UpdateEffects(element) {
        ...
        nbProperties += SetCSSPropertyIf(
                element,
                "outline-offset",
                GetCSSProperty(element, "outline-offset") != "0px"
        );
        nbProperties += SetCSSPropertyIf(
                element,
                "box-sizing",
                GetCSSProperty(element, "box-sizing") != "content-box"
        );
        nbProperties += SetCSSPropertyIf(
                element,
                "resize",
                GetCSSProperty(element, "resize") != "none"
        );

        nbProperties += SetCSSPropertyIf(
                element,
                "text-shadow",
                GetCSSProperty(element, "text-shadow") != "none"
        );
        nbProperties += SetCSSPropertyIf(
                element,
                "text-overflow",
                GetCSSProperty(element, "text-overflow") != "clip"
        );
        nbProperties += SetCSSPropertyIf(
                element,
                "word-wrap",
                GetCSSProperty(element, "word-wrap") != "normal"
        );
        nbProperties += SetCSSPropertyIf(
                element,
                "box-shadow",
                GetCSSProperty(element, "box-shadow") != "none"
        );

        nbProperties += SetCSSPropertyIf(
                element,
                "border-top-left-radius",
                GetCSSProperty(element, "border-top-left-radius") != "0px"
        );
        nbProperties += SetCSSPropertyIf(
                element,
                "border-top-right-radius",
                GetCSSProperty(element, "border-top-right-radius") != "0px"
        );
        nbProperties += SetCSSPropertyIf(
                element,
                "border-bottom-left-radius",
                GetCSSProperty(element, "border-bottom-left-radius") != "0px"
        );
        nbProperties += SetCSSPropertyIf(
                element,
                "border-bottom-right-radius",
                GetCSSProperty(element, "border-bottom-right-radius") != "0px"
        );
...
function CSSViewerMouseOver(e) {
        ...
        for (var i = 0; i < CSSViewer_pFont.length; i++)
                CSSViewer_element_cssDefinition +=
                        ...
                        CSSViewer_pFont[i] +
                        ": " +
                        element.getPropertyValue(CSSViewer_pFont[i]) +
                        ";\n";
        ...
        for (var i = 0; i < CSSViewer_pColorBg.length; i++)
                CSSViewer_element_cssDefinition +=
                        "\t" +
                        CSSViewer_pColorBg[i] +
                        ": " +
                        element.getPropertyValue(CSSViewer_pColorBg[i]) +
                        ";\n";
        ...
        for (var i = 0; i < CSSViewer_pBox.length; i++)
                CSSViewer_element_cssDefinition +=
                        ...
                        CSSViewer_pBox[i] +
                        ": " +
                        element.getPropertyValue(CSSViewer_pBox[i]) +
                        ";\n";
        ...
        for (var i = 0; i < CSSViewer_pPositioning.length; i++)
                CSSViewer_element_cssDefinition +=
                        "\t" +
                        CSSViewer_pPositioning[i] +
                        ": " +
                        element.getPropertyValue(CSSViewer_pPositioning[i]) +
                        ";\n";
        ...
        for (var i = 0; i < CSSViewer_pList.length; i++)
                CSSViewer_element_cssDefinition +=
                        ...
                        CSSViewer_pList[i] +
                        ": " +
                        element.getPropertyValue(CSSViewer_pList[i]) +
                        ";\n";
        ...
        for (var i = 0; i < CSSViewer_pTable.length; i++)
                CSSViewer_element_cssDefinition +=
                        ...
                        CSSViewer_pTable[i] +
                        ": " +
                        element.getPropertyValue(CSSViewer_pTable[i]) +
                        ";\n";
        ...
        for (var i = 0; i < CSSViewer_pMisc.length; i++)
                CSSViewer_element_cssDefinition +=
                        ...
                        CSSViewer_pMisc[i] +
                        ": " +
                        element.getPropertyValue(CSSViewer_pMisc[i]) +
                        ";\n";
        ...
        for (var i = 0; i < CSSViewer_pEffect.length; i++)
                CSSViewer_element_cssDefinition +=
                        ...
                        CSSViewer_pEffect[i] +
                        ": " +
                        element.getPropertyValue(CSSViewer_pEffect[i]) +
                        ";\n";
...
function CSSViewerMouseMove(e) {
        ...
        var blockWidth = 332;
        var blockHeight = document.defaultView
...
function CSSViewer() {
        ...
        this.CreateBlock = function () {
                ...
                if (document) {
                        ...
                        for (var cat in CSSViewer_categories) {
                                ...
                                for (var i = 0; i < properties.length; i++) {
                                        ...
                                        var spanName = document.createElement(
                                                "span"
                                        );
                                        ...
                                        var spanValue = document.createElement(
                                                "span"
                                        );
                        ...
                        footer.appendChild(
                                document.createTextNode(
                                        "CSSViewer 1.7. keys: [f] Un/Freeze. [c] Css. [Esc] Close."
                                )
                        );
                ...
                cssViewerInsertMessage(
                        "CSSViewer loaded! Hover any element you want to inspect in the page."
                );
        ...
        this.AddCSS = function (cssFile) {
                ...
                if (heads.length > 0) heads[0].appendChild(link);
...
function cssViewerCopyCssToConsole(type) {
        ...
        if ("className" == type)
                return console.log(CSSViewer_element.className);
        ...
        if ("simpleCssDefinition" == type)
                return console.log(CSSViewer_element_cssDefinition);
}
